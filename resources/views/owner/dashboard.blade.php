...
<div class="sheet-ov" id="periodeSheet" onclick="if(event.target===this)this.classList.remove('open')">
    <div class="sheet-box">
        ...
        <div class="sheet-opt {{ $period==='selama'?'sel':'' }}" onclick="pickPeriod('selama')">Selama ini <span>{{ $period==='selama'?'✓':'' }}</span></div>
        <div class="sheet-opt {{ $period==='hari'?'sel':'' }}" onclick="pickPeriod('hari')">Hari ini <span>{{ $period==='hari'?'✓':'' }}</span></div>
        <div class="sheet-opt {{ $period==='minggu'?'sel':'' }}" onclick="pickPeriod('minggu')">Seminggu ini <span>{{ $period==='minggu'?'✓':'' }}</span></div>
